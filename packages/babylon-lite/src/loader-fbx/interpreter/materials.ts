...
import { getPropertyTemplate, resolvePropertyValue, resolvePropertyValues } from "./property-templates.js";
...
export interface FBXMaterialData {
    ...
    /** Shading model. */
    type: "Lambert" | "Phong";
    /** Resolved scalar/color material properties. */
    properties: FBXMaterialProperties;
    /** Textures connected to this material. */
    textures: FBXTextureRef[];
}

/** Resolved FBX surface material properties. */
...
/** A texture connected to a material property. */
