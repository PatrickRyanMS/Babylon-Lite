...
import { cleanFBXName, findChildByName, findChildrenByName, getPropertyValue } from "../types/fbx-types.js";
...
function buildTriangleMesh(
    ...
    // Normals stay in RH space (root node handles conversion) — no transformation needed.
