...
// Opt-in enablers for the Standard material's deform/vertex features (vertex color, skeleton) and UV
// offset (net-neutral when unused). Loaders/scenes call these when they build meshes that use the
// feature (e.g. an in-code skinned/vertex-colored scene — see scene231; the FBX loader calls them
// internally).
export { enableStandardVertexColor, enableStandardSkeleton, enableStandardUvOffset } from "./material/standard/enable-standard-mesh-features.js";
