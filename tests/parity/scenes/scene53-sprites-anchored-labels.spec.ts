/**
 * Scene 53 — Sprites Anchored Labels Parity Test (Family 2)
 *
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../reference/scene53-sprites-anchored-labels");
...
test("Scene 53 — Sprites Anchored Labels match Lite-fallback golden", async ({ page }, testInfo) => {
